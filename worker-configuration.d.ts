/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec1c60f2f693eaf6976ab450e3404f2b)
// Runtime types generated with workerd@1.20260826.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	GENERATED_ART: R2Bucket;
	ASSETS: Fetcher;
	...
	ASCEND_GENERATION_ADMIN_TOKEN: string;
	GENERATION_WORKFLOW: Workflow<Parameters<import("./worker/index").AscendGenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GENERATION_ENABLED" | "OPENAI_IMAGE_MODEL" | "OPENAI_IMAGE_SIZE" | "OPENAI_IMAGE_QUALITY" | "OPENAI_API_KEY" | "ASCEND_GENERATION_ADMIN_TOKEN">> {}
}
